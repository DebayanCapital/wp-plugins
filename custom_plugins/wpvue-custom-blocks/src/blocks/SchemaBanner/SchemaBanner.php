 ...
 * Schema Banner class.
 */
class SchemaBanner extends AbstractBlock {
	 ...
	 * @var string
	 */
	protected $block_name = 'schema-banner';
	...
	protected function get_attributes() {
		return array_merge(
			...
			array(
                ...
                'banner_description'=> $this->get_schema_string(),
	...
	public function render_filtered_content( $content, $block ) {
		...
		$output['banner_description']=$attributes['banner_description'];
